        ...
        <div className="grid items-center gap-y-10 gap-x-8 md:grid-cols-12 md:gap-x-12 md:gap-y-12 lg:gap-x-16">
          ...
          <Reveal type="fade-up" delay={120} className="md:col-span-7 lg:col-span-8">
            ...
            <p className="mt-6 text-base leading-relaxed text-gray-700 sm:text-lg lg:text-[1.125rem] lg:leading-8 max-w-none lg:max-w-3xl break-normal">
              สวัสดีค่ะ หนูชื่อ พิมพ์พิสุทธิ์ เก้ากฤษฎี ชื่อเล่นว่า ปอร์เช่ ปัจจุบันกำลังศึกษาอยู่ชั้นปี 4 สาขาวิทยาการคอมพิวเตอร์ค่ะ ตอนนี้กำลังมองหาโอกาสฝึกงานเพื่อพัฒนาทักษะและเรียนรู้
               การทำงานจริง ๆ นอกห้องเรียนระหว่างเรียนเคยได้ลองทำโปรเจกต์เลยพอได้รู้จักการทำงานในบทบาทต่าง ๆ บ้าง ซึ่งทำให้เห็นว่าการทำงานจริงน่าจะมีรายละเอียดและความท้าทายอีกหลายอย่างที่ยังไม่เคยเจอเลย
               อยากใช้โอกาสฝึกงานครั้งนี้ในการเรียนรู้เพิ่มเติมและพัฒนาตัวเองให้พร้อมสำหรับการทำงานในอนาคตค่ะ
            </p>
